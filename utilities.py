...
def convert_any_to_wav(filename):
    """
        This program converts the input file into the WAV format.
    """
    pass
...
def convert_dataset_to_wav(file_name):
    """
        It converts all files of the GTZAN dataset into the WAV (uncompressed) format.
    """
...
def plot_confusion_matrix(cm, genre_list, name, title):
    """
        It plots the confusion matrices.
    """
    pylab.clf()
